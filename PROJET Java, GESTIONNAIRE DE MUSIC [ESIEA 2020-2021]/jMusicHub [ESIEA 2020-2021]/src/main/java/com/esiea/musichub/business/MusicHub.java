package com.esiea.musichub.business;
...
import com.esiea.musichub.util.XMLHandler;
...
public class MusicHub {
    public static final String ALBUMS_FILE_PATH = "src/main/resources/files/albums.xml";
    public static final String PLAYLISTS_FILE_PATH = "src/main/resources/files/playlists.xml";
    public static final String ELEMENTS_FILE_PATH = "src/main/resources/files/elements.xml";
    ...
    public boolean isSongExist(String albumTitle, String songTitle) throws NoAlbumFoundException {
        boolean isExist = false;
        Album theAlbum = null;
        List<Song> songsInAlbum = this.getAlbumSongsSortedByGenre(albumTitle);
        for (Song song : songsInAlbum) {
            if (song.getContent().toLowerCase().equals(songTitle.toLowerCase())) {
                isExist = true;
                break;
            }
        }
    ...
    public List<String> availableCommands() {
        ...
        listOfCommands.add("t: display the album titles, ordered by date");
        listOfCommands.add("g: display songs of an album, ordered by genre");
        listOfCommands.add("d: display songs of an album");
        listOfCommands.add("u: display audiobooks ordered by author");
        listOfCommands.add("p: display playlist");
        listOfCommands.add("f: play sound");
        listOfCommands.add("c: add a new song");
        listOfCommands.add("a: add a new album");
        listOfCommands.add("+: add a song to an album");
        listOfCommands.add("l: add a new audiobook");
        listOfCommands.add("y: create a new playlist from existing songs and audio books");
        listOfCommands.add("-: delete an existing playlist");
        listOfCommands.add("s: save elements, albums, playlists");
        listOfCommands.add("q: logout & quit program");
