...
$dirLessonS1     = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/LessonsS1/';
$lessonS1        = scandir($dirLessonS1);
$titlesLessonsS1 = array();
$dirLessonS2     = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/LessonsS2/';
$lessonS2        = scandir($dirLessonS2);
$titlesLessonsS2 = array();

$dirTDS1         = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TDS1/';
$TDS1            = scandir($dirTDS1);
$titlesTDS1      = array();
$dirTDS2         = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TDS2/';
$TDS2            = scandir($dirTDS2);
$titlesTDS2      = array();

$dirTPS1         = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TPS1/';
$TPS1            = scandir($dirTPS1);
$titlesTPS1      = array();
$dirTPS2         = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TPS2/';
$TPS2            = scandir($dirTPS2);
$titlesTPS2      = array();

$dirProjects     = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/Projects/';
$Projects        = scandir($dirProjects);
$titlesProjects  = array();

$dirFilePerso     = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/filePerso/';
