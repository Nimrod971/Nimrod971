<?php
    for ($i = 0; $i < $nbLessonsS1; $i++) {
        ...
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/LessonsS1/';
    ...
    for ($i = 0; $i < $nbLessonsS2; $i++) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/LessonsS2/';
    ...
    for ($i = 0; $i < $nbFilePerso; $i++) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/filePerso/';
    ...
    if (isset($_POST['formDeleteTDS1'])) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TDS1/';
        $cptFile = $nbTDS1;
    ...
    if (isset($_POST['formDeleteTPS1'])) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TPS1/';
        $cptFile = $nbTPS1;
    ...
    if (isset($_POST['formDeleteTDS2'])) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TDS2/';
        $cptFile = $nbTDS2;
    ...
    if (isset($_POST['formDeleteTPS2'])) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/TPS2/';
        $cptFile = $nbTPS2;
    ...
    if (isset($_POST['formDeleteProjects'])) {
        $_GET['promo'] = htmlspecialchars($_GET['promo']);
        $pathToDelete = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/info/Projects/';
        $cptFile = $nbProject;
