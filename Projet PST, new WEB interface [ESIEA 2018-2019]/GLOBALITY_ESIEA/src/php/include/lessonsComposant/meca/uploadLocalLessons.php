            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/LessonsS1/'.$file_name;
    ...
    if (isset($_FILES['fileLessonS2'])) {
        ...
        for ($i = 0; $i < $totalLessonS2; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/LessonsS2/'.$file_name;
    ...
    if (isset($_FILES['fileTDS1'])) {
        ...
        for ($i = 0; $i < $totalTDS1; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/TDS1/'.$file_name;
    ...
    if (isset($_FILES['fileTDS2'])) {
        ...
        for ($i = 0; $i < $totalTDS2; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/TDS2/'.$file_name;
    ...
    if (isset($_FILES['fileTPS1'])) {
        ...
        for ($i = 0; $i < $totalTPS1; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/TPS1/'.$file_name;
    ...
    if (isset($_FILES['fileTPS2'])) {
        ...
        for ($i = 0; $i < $totalTPS2; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/TPS2/'.$file_name;
    ...
    if (isset($_FILES['fileProjects'])) {
        ...
        for ($i = 0; $i < $totalProjects; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/Projects/'.$file_name;
    ...
    if (isset($_FILES['filePerso'])) {
        ...
        for ($i = 0; $i < $totalPerso; $i++) {
            ...
            if (in_array($file_ext, $allowed)) {
                if ($file_error === 0) {
                    if ($file_size < 2097152) {
                        $file_destination = '../../../src/data/class/'.$_SESSION['username'].'/'.$_GET['promo'].'/meca/filePerso/'.$file_name;
