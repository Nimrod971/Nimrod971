 ...
 <a href="../lessons.php" class="returnMenu"><i class="fas fa-undo"></i></a>
  ...
  <div class="header" style="display: block;">
      <div class="header-content">
          <a href="#top" class="header-title">Mathématiques <?= $_GET['promo'] ?>A <blue>ESIEA</blue></a>
  ...
  if (is_dir('../../../src/data/class/'.$_SESSION['username'].'/')) {
      include '../../../src/php/include/lessonsComposant/maths/getLessons.php';
  ?>
      ...
      <div class="columns">
          <div class="column">
              ...
              <ul class="lesson-list">
                  ...
                  <li>
                      <a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/LessonsS1/<?= $titlesLessonsS1[$i] ?>" target="_blank"><?= shortString(printWithoutExtension($titlesLessonsS1[$i]), 30) ?></a>
          ...
          <div class="column">
              ...
              <ul class="lesson-list">
                  ...
                  <li>
                      <a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/LessonsS2/<?= $titlesLessonsS2[$i] ?>" target="_blank"><?= shortString(printWithoutExtension($titlesLessonsS2[$i]), 30) ?></a>
                      <form action="#" method="post">
  ...
  <?php include '../../../src/php/include/lessonsComposant/maths/uploadLocalLessons.php'; ?>
  <?php include '../../../src/php/include/lessonsComposant/maths/deleteLesson.php'; ?>
  <?php include '../../../src/php/include/lessonsComposant/maths/getLink.php'; ?>
  <?php include '../../../src/php/include/lessonsComposant/maths/deleteLink.php'; ?>
          ...
          <div class="colum">
              ...
              <div class="works">
                  <ul class="td-list">
                      ...
                      <li><a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/TDS1/<?= $titlesTDS1[$i] ?>" target="_blank"><?= printWithoutExtension($titlesTDS1[$i]) ?></a></li>
                      <?php } ?>
                  </ul>
                  <ul class="tp-list">
                      <?php for ($i = 0; $i < $nbTPS1; $i++) { ?>
                      <li><a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/TPS1/<?= $titlesTPS1[$i] ?>" target="_blank"><?= printWithoutExtension($titlesTPS1[$i]) ?></a></li>
                      <?php } ?>
                  </ul>
              </div>
          </div>
          <div class="colum">
              ...
              <div class="works">
                  <ul class="td-list">
                      ...
                      <li><a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/TDS2/<?= $titlesTDS2[$i] ?>" target="_blank"><?= printWithoutExtension($titlesTDS2[$i]) ?></a></li>
                      <?php } ?>
                  </ul>
                  <ul class="tp-list">
                      <?php for ($i = 0; $i < $nbTPS2; $i++) { ?>
                      <li><a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/TPS2/<?= $titlesTPS2[$i] ?>" target="_blank"><?= printWithoutExtension($titlesTPS2[$i]) ?></a></li>
                      <?php } ?>
                  </ul>
              </div>
          </div>
      ...
      <?php for ($i = 0; $i < $nbProject; $i++) { ?>
          <div class="project-content">
              <nav class="project-header">
                  ...
                  <div>
                      <a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/Projects/<?= $titlesProjects[$i] ?>" class="project-btn" download >Download</a>
                  </div>
              </nav>
          </div>
      <?php } ?>
      ...
      <div class="columns">
          <div class="column">
              ...
              <ul class="lesson-list">
                  ...
                  <li>
                      <a href="../../../src/data/class/<?= $_SESSION['username'] ?>/<?= $_GET['promo'] ?>/maths/filePerso/<?= $titlesFilePerso[$i] ?>" target="_blank"><?= printWithoutExtension($titlesFilePerso[$i]) ?></a>
                      <form action="#" method="post">
  ...
  <?php include '../../../src/php/include/lessonsComposant/maths/uploadLink.php'; ?>
  <?php
} else { ?>
    <div class="alertMessage">
        ...
        <p class="message">
            ...
            Veuillez créer votre dosser dans les paramètres section <red>"fonctionnalité"</red> en cliquant sur <red>"Activé les fonctionnalité"</red></br>
