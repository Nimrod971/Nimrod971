...
//strcpy(copie, chazne); // On copie "train" dans "TrainX.custom" afin de représenter chaque train
	...
	while (pos_bar1!=125)
	{
		printf("\033[1;37m\033[23;%dH%c",pos_bar1,barr);	
		pos_bar1++;			
	}
	
	while (pos_bar2!=90)
	{
		printf("\033[1;37m\033[29;%dH%c",pos_bar2,barr);	
		pos_bar2--;			
	}
			...
			if (timing==100)
			 {
				...
				deplacement(maliste,Train2.etat,Train1.etat);  
				...
				g=TrajetDG (g,StopDG,tempsAttenteD,Train2.posy);		// TRAJET T2
						...
						if (j==StopGD)
						{
							...
							compteurarret1=stop1(j,StopGD,compteurarret1);	/// ARRET DU T1
								...
								if (compteurarret1 >= 3 && compteurarret1 <= 80 )
								{
							
									if (pos_bar1!=125)
									{
										printf("\033[1;37m\033[29;%dH%c\n",pos_bar1,barrV);
									...
									if (compteurarret1>=38 && compteurarret1 <= 44 )
								{
									Train1.etat=1;
									insertion4(maliste);
									insertion4(maliste);
							...
							if (compteurarret1 >= 190 )
							{
									if (pos_bar1!=90)
									{
										printf("\033[1;37m\033[29;%dH%c",pos_bar1,barr);				
										pos_bar1--;	
							...
							if (compteurarret1==240)
							{
									j++;
									compteurarret1=0;
									if (Train1.etat== 0 || Train2.etat==0)
											{
													insertion(maliste);
													insertion(maliste);
													insertion(maliste);
						...
						if (g==StopDG)
					{
						compteurarret2=stop2(g,StopDG,compteurarret2);	/// ARRET DU T2
							...
							if (compteurarret2 >= 3 && compteurarret2 <= 80 )
							{
								if (pos_bar2!=90)
								{
									printf("\033[1;37m\033[23;%dH%c",pos_bar2,barrV);				
									pos_bar2--;			
								}
											
							}
							
							if (compteurarret2>=38 && compteurarret2 <= 44 )
								{
							...
							if (compteurarret2 >= 190 )
							{
								if (pos_bar2!=125)
								{
									printf("\033[1;37m\033[23;%dH%c",pos_bar2,barr);
		...
		////////////////////// 			DÉCORATION VOITURE 			//////////////////////////
			...
			///////////////////////////////////////////////////////////////////:			
				...
				///////////////////////////////////////////////////////////////		
					...
					if (compteurarret1 == 15 || compteurarret2 == 15 )
											{
													system("play -q ratp.mp3 vol 1 &");
											}		
